...
public class SalaryHtmlReportNotifier {
    ...
    public void generateAndSendHtmlSalaryReport(String departmentId, DateRange dateRange, String recipients) {
        try {
            ResultSet results = executeQuery(departmentId,dateRange);
    ...
    private ResultSet executeQuery(String departmentId, DateRange dateRange)throws SQLException{
    ...
    private StringBuilder generateHtml(ResultSet results) throws SQLException{
